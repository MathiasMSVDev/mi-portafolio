                ...
                for (var t = 0; t < e.length; t++) {
                    ...
                    if (r && "" !== r) {
                        var r = JSON.parse(r),
                            ...
                            s = r.markers,
                            a = L.map(e[t], { scrollWheelZoom: c }).setView(
                                o,
                                l
                            );
                        if (
            ...
            for (
                var e = document.querySelectorAll(".swiper"),
                    t = function (e, t) {
                        ...
                        r.controlledSlider &&
                            (null !=
                                (n = document.querySelector(r.controlledSlider))
                                    .dataset.swiperOptions &&
                                (a = JSON.parse(n.dataset.swiperOptions)),
                            (n = new Swiper(n, a)),
            ...
            if (0 !== e.length || 0 !== t.length || 0 !== c.length) {
                ...
                for (var S = 0; S < c.length; S++)
                    !(function (e) {
                        ...
                        if (
                            (c[e].classList.add("ct-pie-chart-" + e), null != a)
                        )
                            for (
                                var n = JSON.parse(a), o = 0;
                                o < n.colors.length;
                                o++
                            )
                                (s = "\n          .ct-pie-chart-"
